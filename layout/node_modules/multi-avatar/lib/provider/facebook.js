  ...
  _createClass(_class, [{
    ...
    value: function avatar(size) {
      ...
      return new _anyPromise2.default(function (resolve) {
        if (!_this.facebookId) return reject(new Error('Facebook user ID is not specified'));

        return resolve('https://graph.facebook.com/' + _this.facebookId + '/picture?width=' + size);
      });
    }
  }]);
