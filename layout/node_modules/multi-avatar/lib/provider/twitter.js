  ...
  _createClass(_class, [{
    ...
    value: function avatar(size) {
      ...
      return new _anyPromise2.default(function (resolve, reject) {
        if (!_this.twitterName) return reject(new Error('Twitter user name is not specified'));

        return resolve('https://twitter.com/' + _this.twitterName + '/profile_image?size=' + _this.getImageSize(size));
      });
    }
  }]);
